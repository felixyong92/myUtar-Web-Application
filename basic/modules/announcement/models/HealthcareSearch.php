...
/**
 * HealthcareSearch represents the model behind the search form about `app\modules\announcement\models\Healthcare`.
 */
class HealthcareSearch extends Healthcare
{
	public $department = '';
