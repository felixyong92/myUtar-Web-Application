...
use app\modules\announcement\models\SafetySearch;
...
class SafetyController extends Controller
{
	...
	public function beforeAction($action)
	{
		...
		else if (Yii::$app->user->identity->dsResponsibility !== 'Super Admin' && !stristr(Yii::$app->user->identity->dsResponsibility, 'Safety')) 
